        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="space-y-4">
              {[
                { action: "New student enrolled", time: "2 minutes ago", icon: FiUsers, color: "text-blue-500" },
                { action: "Exam results published", time: "1 hour ago", icon: FiAward, color: "text-green-500" },
                { action: "Fee payment received", time: "3 hours ago", icon: FiDollarSign, color: "text-orange-500" },
                { action: "Notice published", time: "5 hours ago", icon: FiAlertCircle, color: "text-purple-500" }
              ].map((activity, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <div className={`p-3 rounded-lg bg-white dark:bg-gray-800 ${activity.color}`}>
